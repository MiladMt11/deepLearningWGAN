...
class WGAN():
    ...
    def save(self):
        torch.save({"epoch": self.epoch,
                    ...
                    "Best FID score": self.best_fid}, "../checkpoint/SN_WGAN_MNIST/G.pth")
        ...
        if self.epoch == self.maxepochs:
            torch.save({"epoch": self.epoch,
                        ...
                        "losses_G": self.G_losses,
                        "FID scores": self.fid_score,
                        "Best FID score": self.best_fid}, "../checkpoint/SN_WGAN_MNIST/G_{}.pth")
            torch.save({"D_state_dict": self.D.state_dict(),
                        "optimizer_D": self.optim_D.state_dict(),
                        "losses_fake": self.Fake_losses,
                        "losses_real": self.Real_losses}, "../checkpoint/SN_WGAN_MNIST/D_{}.pth".format(self.epoch))
        print("model saved!")
